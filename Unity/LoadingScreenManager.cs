 ...
 * 
 *  Making a loading screen. Allows for some extra flexibility too. 
 *  Combined aspects from both tutorials to make this.
 * 
 *  Original built by Martin Nerurkar (http://www.martin.nerurkar.de)
